...
**v3.0.5** — Thread-safe, zero-dependency automatic background TCP & Protobuf library for ESP32 and ESP8266.  
...
**v3.0.5** — Library TCP & Protobuf otomatis latar belakang yang thread-safe dan bebas dependensi eksternal untuk ESP32 dan ESP8266.  
